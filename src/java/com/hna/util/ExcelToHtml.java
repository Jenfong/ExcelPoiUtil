...
public class ExcelToHtml {
	...
	private static final short ALIGN_FILL = 4;
	private static final short ALIGN_JUSTIFY = 5;
	private static final short ALIGN_CENTER_SELECTION = 6;
	
	private static final short VERTICAL_BOTTOM = 2;
	private static final short VERTICAL_CENTER = 1;
	private static final short VERTICAL_TOP = 0;
	
	private static final short BORDER_NONE = 0;
	private static final short BORDER_THIN = 1;
	private static final short BORDER_MEDIUM = 2;
	private static final short BORDER_DASHED = 3;
	private static final short BORDER_HAIR = 4;
	private static final short BORDER_THICK = 5;
	private static final short BORDER_DOUBLE = 6;
	private static final short BORDER_DOTTED = 7;
	private static final short BORDER_MEDIUM_DASHED = 8;
	private static final short BORDER_DASH_DOT = 9;
	private static final short BORDER_MEDIUM_DASH_DOT = 10;
	private static final short BORDER_DASH_DOT_DOT = 11;
	private static final short BORDER_MEDIUM_DASH_DOT_DOT = 12;
	private static final short BORDER_SLANTED_DASH_DOT = 13;
	...
	public static Map<String, Object> execute(String path) throws Exception {
		String outputName = Constant.DEFUALT_FILE_PATH + "excel_"
				+ System.currentTimeMillis() + ".html";
		Map<String, Object> map = new HashMap<String, Object>();
		File file = new File(outputName);
		file.getParentFile().mkdirs();
		ExcelToHtml toHtml = create(path, new PrintWriter(new FileWriter(file)));
		toHtml.setCompleteHTML(true);
		toHtml.printPage();
		map.put("html", outputName);
		return map;
	}
	...
	/**
	 * 处理多sheet 默认处理第一个 Description: <br>
	 */
